...
from equinox.nn._conv import _ntuple, _padding_init, _padding_mode_init
from equinox.nn._misc import default_init, named_scope
from jaxtyping import Array, PRNGKeyArray


class ConvTranspose(Module):
    """General N-dimensional transposed convolution. Code from equinox with only very
    minor changes.

    Identical to equinox.nn.ConvTranspose except that this can accept an optional
    output_padding argument in the forward pass."""
    ...
    def _padding_transpose(
        self, output_padding: tuple[int, ...] | None
    ) -> tuple[tuple[int, int], ...]:
    ...
    def __call__(
        ...
        *,
        ...
        - `output_padding`: Optional output_padding. If provided, overrides
            self.output_padding.
        ...
        **Returns:**
        ...
        padding_t = self._padding_transpose(output_padding)
